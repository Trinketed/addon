...
Tests:It("GetsResetTimes", function()
    assert(DRList:GetResetTime() == 16.5)
    assert(DRList:GetResetTime("stun") == 16.5)
    assert(DRList:GetResetTime(123) == 16.5)
    assert(DRList:GetResetTime(true) == 16.5)
    assert(DRList:GetResetTime({}) == 16.5)
    assert(DRList:GetResetTime("knockback") == 10.5)
    assert(DRList:GetResetTime("npc") == 16.5)
end)
...
Tests:It("GetsNextDR", function()
    ...
    assert(DRList:GetNextDR(2, "stun") == 0)
    ...
    assert(DRList:GetNextDR(0, "random_stun") == 0)
    ...
    assert(DRList:GetNextDR(2, "knockback") == 0)
...
Tests:It("NextDR", function()
    ...
    assert(DRList:NextDR(0.5, "stun") == 0)
    ...
    assert(DRList:NextDR(1, "knockback") == 0)
    assert(DRList:NextDR(0.5, "knockback") == 0)

    assert(DRList:NextDR(1, "asdf") == 0.50)
    assert(DRList:NextDR(0.5, "asdf") == 0)
